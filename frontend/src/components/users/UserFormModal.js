...
function UserFormModal({
      ...
      setFormData({
        ...
        roleId:
          typeof initialData.role === "object"
            ? initialData.role._id || initialData.role.id
            : initialData.roleId || initialData.role || "",
        department:
          typeof initialData.department === "object" && initialData.department
            ? initialData.department._id || initialData.department.id
            : initialData.department || initialData.department_name || "",
        jobTitle:
  ...
  useEffect(() => {
    ...
    setFormData((prev) => ({ ...prev, roleId: createdRoleId }));
    setErrors((prev) => ({ ...prev, roleId: undefined }));
  }, [isOpen, createdRoleId]);
  ...
  useModalKeyboard(isOpen && !keyboardDisabled, onClose, handleSubmit);
          ...
          <div className="modal-body">
            <div className="form-row">
              <div className="form-group">
                ...
                />
                {errors.firstName && (
                  <small style={{ color: "#dc2626" }}>{errors.firstName}</small>
                )}
              </div>
              <div className="form-group">
                ...
                />
                {errors.lastName && (
                  <small style={{ color: "#dc2626" }}>{errors.lastName}</small>
                )}
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                />
                {errors.email && (
                  <small style={{ color: "#dc2626" }}>{errors.email}</small>
                )}
              </div>
              <div className="form-group">
                <label>Phone</label>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                />
                {errors.password && (
                  <small style={{ color: "#dc2626" }}>{errors.password}</small>
                )}
              </div>
              <div className="form-group">
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                {errors.roleId && (
                  <small style={{ color: "#dc2626" }}>{errors.roleId}</small>
                )}
              </div>
              <div className="form-group">
                <label className="form-label-add">
                    ...
                    >
                      ...
                      {(departments || []).map((dept) => (
                        <option
                          ...
                          value={dept._id || dept.id || dept.name}
                        >
