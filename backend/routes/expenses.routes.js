...
router.get('/accounts', authenticate, authorize(...fin), expenses.listAccounts);
...
router.get('/items', authenticate, authorize(...fin), expenses.listExpenses);
router.post('/items', authenticate, authorize(...fin), expenses.createExpense);
router.patch('/items/:id', authenticate, authorize(...fin), expenses.updateExpense);
router.post('/items/:id/post', authenticate, authorize('super_admin', 'admin', 'accountant'), expenses.postExpense);
